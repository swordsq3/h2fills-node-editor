...
from node.deep_learning_node.semantic_segmentation.deeplab_v3.deeplab_v3 import (
    DeepLabV3,
)
from node.deep_learning_node.semantic_segmentation.road_segmentation_adas_0001.road_segmentation import (
    RoadSegmentation,
)
from node.deep_learning_node.semantic_segmentation.skin_clothes_hair_segmentation.skin_clothes_hair_segmentation import (
...
class Node(DpgNodeABC):
    ...
    _model_class = {
        "DeepLabV3": DeepLabV3,
        "Road Segmentation ADAS 0001": RoadSegmentation,
        "Skin Clothes Hair Segmentation": SkinClothesHairSegmentation,
        "MediaPipe SelfieSegmentation(Normal)": MediaPipeSelfieSegmentationNormal,
        "MediaPipe SelfieSegmentation(LandScape)": MediaPipeSelfieSegmentationLandScape,
    }
    _model_base_path = (
        os.path.dirname(os.path.abspath(__file__)) + "/semantic_segmentation/"
    )
    _model_path_setting = {
        "DeepLabV3": _model_base_path + "deeplab_v3/model/deeplab_v3_1_default_1.onnx",
        "Road Segmentation ADAS 0001": _model_base_path
        + "road_segmentation_adas_0001/model/road_segmentation_adas_0001.onnx",
        "Skin Clothes Hair Segmentation": _model_base_path
        + "skin_clothes_hair_segmentation/model/skin_clothes_hair_segmentation.onnx",
    ...
    def update(
        ...
        result = {}
        if frame is not None:
            class_num = self._model_instance[model_name_with_provider].get_class_num()
            segmentation_map = self._model_instance[model_name_with_provider](frame)
