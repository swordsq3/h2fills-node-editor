...
class Node(DpgNodeABC):
    ...
    _model_base_path = (
        os.path.dirname(os.path.abspath(__file__)) + "/low_light_image_enhancement/"
    )
    _model_path_setting = {
        "TBEFN(320x180)": _model_base_path + "TBEFN/model/tbefn_180x320.onnx",
        "TBEFN(640x360)": _model_base_path + "TBEFN/model/tbefn_360x640.onnx",
        "SCI(320x180)": _model_base_path + "SCI/model/sci_180x320.onnx",
        "SCI(640x360)": _model_base_path + "SCI/model/sci_360x640.onnx",
        "AGLLNet(256x256)": _model_base_path + "AGLLNet/model/agllnet_256x256.onnx",
        "AGLLNet(512x384)": _model_base_path + "AGLLNet/model/agllnet_384x512.onnx",
    }
