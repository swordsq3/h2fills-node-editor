...
from node.deep_learning_node.monocular_depth_estimation.FSRE_Depth.fsre_depth import (
    FSRE_Depth,
)
from node.deep_learning_node.monocular_depth_estimation.HR_Depth.hr_depth import (
    HR_Depth,
)
...
class Node(DpgNodeABC):
    ...
    _model_base_path = (
        os.path.dirname(os.path.abspath(__file__)) + "/monocular_depth_estimation/"
    )
    _model_path_setting = {
        "FSRE-Depth(320x192)": _model_base_path
        + "FSRE_Depth/model/fsre_depth_192x320.onnx",
        "FSRE-Depth(640x384)": _model_base_path
        + "FSRE_Depth/model/fsre_depth_384x640.onnx",
        "Lite-HR-Depth(1280x384)": _model_base_path
        + "HR_Depth/model/lite_hr_depth_384x1280.onnx",
        "HR-Depth(1280x384)": _model_base_path
        + "HR_Depth/model/hr_depth_384x1280.onnx",
    }
